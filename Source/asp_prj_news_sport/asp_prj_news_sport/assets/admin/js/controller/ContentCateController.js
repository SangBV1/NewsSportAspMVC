var content_cate = {
    ...
    registerEvents: function () {
            ...
            jQuery('.delete_all').on('click', function (e) {
                ...
                if (allVals.length <= 0) {
                    ...
                    if (check == true) {
                        ...
                        $.ajax({
                            url: "/Admin/ContentCate/DeleteAllChecked",
        ...
        $('.btn-active').off('click').on('click', function (e) {
            ...
            var id = btn.data('id');
            $.ajax({
                url: "/Admin/ContentCate/ChangeActive",
                data: { id: id },
                dataType: "json",
                type: "POST",
                success: function (response) {
        ...
        $('.btn-showhome').off('click').on('click', function (e) {
            e.preventDefault();
            var btn = $(this);
            var id = btn.data('id');
            $.ajax({
                url: "/Admin/ContentCate/ChangeShowHome",
                data: { id: id },
                dataType: "json",
                type: "POST",
                success: function (response) {
